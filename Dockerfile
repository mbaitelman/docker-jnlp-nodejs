...
RUN apk add --update nodejs=${nodejs_version} --repository=http://dl-cdn.alpinelinux.org/alpine/v3.16/main \ 
  && apk add --update npm=${npm_version} --repository=http://dl-cdn.alpinelinux.org/alpine/v3.15/main \
